...
// @Success 200 {object} models.Response "{"code":200,"data":{"user_id":1},"msg":"注册成功"}"
// @Failure 400 {object} models.ErrorResponse "{"code":400,"msg":"参数错误或密码设置失败"}"
// @Failure 500 {object} models.ErrorResponse "{"code":500,"msg":"注册失败"}"
...
// @Success 200 {object} models.Response "{"code":200,"data":{"token":"xxx"},"msg":"登录成功"}"
// @Failure 400 {object} models.ErrorResponse "{"code":400,"msg":"参数错误"}"
// @Failure 401 {object} models.ErrorResponse "{"code":401,"msg":"无效的凭证"}"
// @Failure 500 {object} models.ErrorResponse "{"code":500,"msg":"登录失败"}"
